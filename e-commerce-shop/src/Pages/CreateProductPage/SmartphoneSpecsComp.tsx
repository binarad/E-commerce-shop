...
export default function SmartphoneSpecsComp(props: SmartphoneSpecsProps) {
	...
	return (
		<div className='flex flex-col gap-4 box-border'>
			...
			<h2 className='text-xl font-semibold'>SIM & Memory</h2>
			<TextField
				variant='standard'
				type='number'
				label='SIM Cards'
			...
			<h2 className='text-xl font-semibold'>SD Card</h2>
			<TextField
				variant='standard'
				label='SD Card Support (true/false)'
				value={String(specs?.cd_card_support)}
				onChange={e =>
					handleChange('cd_card_support', e.target.value === 'true')
				}
			/>
			<TextField
				variant='standard'
			...
			<h2 className='text-xl font-semibold'>Front Camera</h2>
			<TextField
				variant='standard'
				type='number'
				label='Quality (MP)'
			...
			<h2 className='text-xl font-semibold'>Main Camera</h2>
			<TextField
				variant='standard'
				type='number'
				label='Quality (MP)'
			...
			<h2 className='text-xl font-semibold'>CPU & Battery</h2>
			<TextField
				variant='standard'
				label='CPU'
				value={specs?.cpu}
